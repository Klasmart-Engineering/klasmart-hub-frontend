...
export function setOpenSideNavigation (state: boolean | undefined, action: Actions) {
    switch (action.type) {
    case ActionTypes.OPEN_SIDE_NAVIGATION:
        return action.payload;
    default:
        return state;
    }
