...
export const permissions = [
    ...
    `delete_an_organization_account_2`,
    `reset_an_organization_account_3`,
    `setup_an_organizations_academic_profile_4`,
    `edit_an_organization_details_5`,
    `update_default_thumbnails_6`,
    `upgrade_organization_publishing_permissions_7`,
    `approve_and_reject_pending_content_8`,
    `create_program_category_9`,
    `change_an_organizations_visibility_settings_10`,
    `view_organization_bill_details_11`,
    `block_org_users_access_12`,
    `create_pricing_plan_13`,
    `logos_1000`,
    `my_account_1010`,
    `my_settings_1020`,
    ...
    `view_org_unpublished_content_211`,
    `view_my_pending_212`,
    ...
    `edit_org_unpublished_content_231`,
    ...
    `edit_attendance_for_completed_assessment_437`,
    ...
    `delete_in_progress_assessments_453`,
    ...
    `view_all_organizations_reports_613`,
    `view_my_reports_614`,
    ...
    `class_load_time_report_621`,
    `time_assessing_load_report_622`,
    `a_teachers_detailed_time_load_report_623`,
    `a_teachers_schedule_load_report_624`,
    `a_teachers_detailed_schedule_load_report_625`,
    `organization_class_achievements_report_626`,
    `school_class_achievements_report_627`,
    `my_class_achievements_report_628`,
    ...
    `skills_taught_by_all_teachers_in_my_school_report_644`,
    `a_teachers_skills_taught_report_645`,
    ...
    `reactivate_own_organization_10221`,
    ...
    `upload_subject_20892`,
    `download_subject_20893`,
    `roles_30100`,
    `role_levels_30101`,
    `roles_and_permissions_30102`,
    `view_roles_and_permissions_30110`,
    `view_role_priority_levels_30111`,
    `view_role_permissions_30112`,
    `create_groups_30220`,
    `create_role_priority_levels_30221`,
    ...
    `create_my_class_users_40222`,
    `create_my_users_40223`,
    `edit_users_40330`,
    `edit_my_school_users_40331`,
    `edit_my_class_users_40332`,
    `edit_my_users_40333`,
    `delete_users_40440`,
    `delete_my_school_users_40441`,
    `delete_my_class_users_40442`,
    `delete_my_users_40443`,
    `upload_users_40880`,
    ...
    `view_bada_rhyme_71000`,
    `view_bada_genius_71001`,
    `view_bada_talk_71002`,
    `view_bada_sound_71003`,
    `view_bada_read_71004`,
    `view_bada_math_71005`,
    `view_bada_stem_71006`,
    `view_badanamu_esl_71007`,
    `undefined_71008`,
    `undefined_71009`,
    `create_bada_rhyme_75000`,
    `create_bada_genius_75001`,
    `create_bada_talk_75002`,
    `create_bada_sound_75003`,
    `create_bada_read_75004`,
    `create_bada_math_75005`,
    `create_bada_stem_75006`,
    `create_badanamu_esl_75007`,
    `undefined_75008`,
    `undefined_75009`,
    `edit_bada_rhyme_78000`,
    `edit_bada_genius_78001`,
    `edit_bada_talk_78002`,
    `edit_bada_sound_78003`,
    `edit_bada_read_78004`,
    `edit_bada_math_78005`,
    `edit_bada_stem_78006`,
    `edit_badanamu_esl_78007`,
    `copy_featured_content_into_library_78008`,
    `download_featured_content_78009`,
    ...
    `view_bada_rhyme_81000`,
    `view_bada_genius_81001`,
    `view_bada_talk_81002`,
    `view_bada_sound_81003`,
    `view_bada_read_81004`,
    `view_bada_math_81005`,
    `view_bada_stem_81006`,
    `view_badanamu_esl_81007`,
    `use_free_as_recommended_content_for_study_81008`,
    `undefinend_81009`,
    `create_bada_rhyme_85000`,
    `create_bada_genius_85001`,
    `create_bada_talk_85002`,
    `create_bada_sound_85003`,
    `create_bada_read_85004`,
    `create_bada_math_85005`,
    `create_bada_stem_85006`,
    `undefined_85007`,
    `undefined_85008`,
    `undefined_85009`,
    `edit_bada_rhyme_88000`,
    `edit_bada_genius_88001`,
    `edit_bada_talk_88002`,
    `edit_bada_sound_88003`,
    `edit_bada_read_88004`,
    `edit_bada_math_88005`,
    `edit_bada_stem_88006`,
    `edit_badanamu_esl_88007`,
    `copy_free_content_into_library_88008`,
    `download_free_content__88009`,
    `publish_free_content_for_all_hub_89000`,
    `publish_free_content_for_specific_orgs_89001`,
    `publish_free_content_for_all_orgs_89002`,
] as const;
