...
export const constantValues = {
    menuLabel: [
        { name: "View Org", path: "/allOrganization", id: "header_viewOrg" },
        { name: "View Users", path: "/user", id: "header_viewUsers" },
        { name: "View Roles", path: "/roles", id: "header_viewGroups" },
        { name: "View Schools", path: "/school", id: "header_viewSchools" },
        { name: "Classes", path: "/classes", id: "header_classes" },
        { name: "Programs", path: "/programs", id: "header_programs" },
        { name: "Grades", path: "/grades", id: "header_grades" },
    ],
    groupData: [
        { id: "Seed Admin", name: "Seed Admin" },
        { id: "Admin", name: "Admin" },
    ...
    gradesData: [
        ...
        { id: "Experimenters", name: "Experimenters" },
    ],
    statusClasses: [
    ...
    programElements: [
        { id: "Bada Rhyme", name: "Bada Rhyme" },
        { id: "Bada Genius", name: "Bada Genius" },
        { id: "Bada Math", name: "Bada Math" },
        { id: "All", name: "All" },
    ],
    gradeDataDummy: [
        {
